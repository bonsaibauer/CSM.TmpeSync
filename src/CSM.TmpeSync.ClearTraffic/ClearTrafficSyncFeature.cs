...
namespace CSM.TmpeSync.ClearTraffic
{
    ...
    public static class ClearTrafficSyncFeature
    {
        ...
        public static void Register()
        {
            ...
            Log.Info(LogCategory.Network, LogRole.Host, "[ClearTraffic] Sync feature enabled | tmpe_listener=enabled.");
            _enabled = true;
        }
        ...
        public static void Unregister()
        {
            ...
            Log.Info(LogCategory.Network, LogRole.Host, "[ClearTraffic] Sync feature disabled | tmpe_listener=disabled.");
            _enabled = false;
        }
    }
}
