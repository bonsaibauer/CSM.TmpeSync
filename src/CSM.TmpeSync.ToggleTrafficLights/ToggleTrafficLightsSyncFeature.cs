...
namespace CSM.TmpeSync.ToggleTrafficLights
{
    ...
    public static class ToggleTrafficLightsSyncFeature
    {
        ...
        public static void Register()
        {
            ...
            Log.Info(LogCategory.Network, "ToggleTrafficLightsSyncFeature ready: TM:PE listener enabled.");
            _enabled = true;
        }
        ...
        public static void Unregister()
        {
            ...
            Log.Info(LogCategory.Network, "ToggleTrafficLightsSyncFeature stopped: TM:PE listener disabled.");
            _enabled = false;
        }
    }
}
