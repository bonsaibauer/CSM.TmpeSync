...
namespace CSM.TmpeSync.Services
{
    internal static class Deps
    {
        ...
        private static Version GetModVersion()
        {
            try
            {
            ...
            {
                return typeof(Deps).Assembly.GetName()?.Version;
            }
        }
        ...
        internal static string[] GetMissingDependencies()
        {
            ...
            Log.Info(
                ...
                FormatVersion(modVersion, 3) ?? "unknown",
                csmEnabled ? "YES" : "NO",
            ...
            LogDependencyVersion(
                ...
                ModMetadata.HarmonyLegacyVersions,
                3);
            ...
            LogDependencyVersion(
                ...
                ModMetadata.TmpeLegacyVersions,
                4);
