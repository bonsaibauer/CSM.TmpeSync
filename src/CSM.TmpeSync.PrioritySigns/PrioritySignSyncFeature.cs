...
namespace CSM.TmpeSync.PrioritySigns
{
    ...
    public static class PrioritySignSyncFeature
    {
        ...
        public static void Register()
        {
            ...
            Log.Info(LogCategory.Network, LogRole.Host, "[PrioritySigns] Sync feature enabled | tmpe_listener=enabled.");
            _enabled = true;
        }
        ...
        public static void Unregister()
        {
            ...
            Log.Info(LogCategory.Network, LogRole.Host, "[PrioritySigns] Sync feature disabled | tmpe_listener=disabled.");
            _enabled = false;
        }
    }
}
