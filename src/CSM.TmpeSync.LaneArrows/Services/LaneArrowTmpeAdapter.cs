...
namespace CSM.TmpeSync.LaneArrows.Services
{
    internal static class LaneArrowTmpeAdapter
    {
        internal static bool TryGetArrowsAtEnd(ushort nodeId, ushort segmentId, out int arrows)
        {
            ...
            {
                Log.Warn(LogCategory.Bridge, "LaneArrows TryGetAtEnd failed | nodeId={0} segmentId={1} error={2}", nodeId, segmentId, ex);
                return false;
            }
        }
        ...
        internal static bool ApplyArrowsAtEnd(ushort nodeId, ushort segmentId, int arrows)
        {
            ...
            {
                Log.Warn(LogCategory.Bridge, "LaneArrows ApplyAtEnd failed | nodeId={0} segmentId={1} arrows={2} error={3}", nodeId, segmentId, (LaneArrowFlags)arrows, ex);
                return false;
            }
        }
