...
namespace CSM.TmpeSync.Util
{
    ...
    internal static class LaneGuidRegistry
    {
        ...
        internal static bool TryResolveLane(LaneGuid laneGuid, out uint laneId)
        {
            ...
            if (GuidToLane.TryGetValue(laneGuid, out laneId) && NetworkUtil.LaneExists(laneId))
                return true;
        ...
        internal static void Rebuild()
        {
            ...
            NetworkUtil.ForEachSegment(segmentId => RefreshSegment(segmentId));
        }
        ...
        {
            laneId = 0;
            if (!NetworkUtil.SegmentExists(laneGuid.SegmentId))
                return false;
